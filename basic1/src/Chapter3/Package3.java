...
public class Package3 {
	...
	public static void main(String[] args) {
		...
		// 범위제약
		System.out.println(random.nextInt(10)); // 0 ~ 9까지 난수
		System.out.println(random.nextInt(10)+1); // 1 ~ 10까지 난수
		...
		// LocalDateTime 클래스 : 자바 8 부터 Date 대체 위해 사용
		// LocalDate 클래스, LocalTime 클래스, LocalDateTime 클래스
		LocalDateTime now = LocalDateTime.now();
		System.out.println(now);
		
		// 특정 날짜 및 시간의 인스턴스 생성
		LocalDateTime date1 = LocalDateTime.of(2024, 7, 17, 9, 40);
		...
		// Date 인스턴스의 toInstance(), toLocalDateTime()
		...
		// Date를 String으로 변경
		// SimpledDateFormat 클래스를 사용하여 지정한 포멧의 문자열로 변경 가능
		...
		// 오전 10:23 2024-07-17
		SimpleDateFormat computerFormat = new  SimpleDateFormat("a hh:mm:ss yyyy-MM-dd");
