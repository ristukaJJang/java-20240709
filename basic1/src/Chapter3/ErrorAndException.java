 ...
 *  에러는 발생시 프로그램 실행 자체가 불가능하지만 예외는 실행은 정상적으로 됨
 *  개발자가 직접 처리 및 예방 가능 
 * */

public class ErrorAndException {
	
	// thorws 키워드로 메서드의 호출부에 예외처리에 대한 강제성 부여
	...
	public static void main(String[] args) {
		...
		try {
			...
			//finally 키워드로 예외 발생 여부와 관계없이 실행할 코드 작성
		...
		System.out.println("프로그램이 정상적으로 완료되었습니다.");
