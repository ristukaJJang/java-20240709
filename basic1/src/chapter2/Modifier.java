 ...
 *  - 매서드 : final 제어자가 붙은 메서드는 재정의(오버라이드)할 수 없음
 ...
 * - 변수 : static 제어자가 붙은 필드는 인스턴스 상관없이 클래스로 바로 접근 가능
 * */
class StaticClass {
	static int number;
	static void method() {}
...
class ModifierCombination {
	...
	//메서드에서 private + final(final 의미가 없음)
	private final void method() {}
	
	//메서드에서 private + abstract 사용 불가
	//클래스와 메서드에서 final + abstract 사용 불가
