 ...
 * 추상 클래스 자체로 인스턴스를 생성할 수 없음, 반드시 추상 클래스를 확장한 하위 클래스로 인스턴스 생성
 * abstract class 추상클래스명 {}
 * 
 * 추상 메서드 : 선언부만 존재하고 구현부는 존재하지 않는 메서드
 * 반드시 추상 클래스 내부 혹은 인터페이스 안에서 선언할 수 있음
 * 반드시 추상 클래스를 확장한 하위 클래스에서 재정의하여 구현해야 한다(오버라이딩)
...
public class AbstractClass {
	...
	public static void main(String[] args) {
		...
		SalesMan2 salesMan2 = new SalesMan2();
		salesMan2.name = "이영희";
		salesMan2.age = 10;
		salesMan2.greet();
		
		Police2 police2 = new Police2();
		police2.name = "고길동";
		police2.age = 30;
		police2.greet();
	}
