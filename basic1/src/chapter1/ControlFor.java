...
public class ControlFor {
	...
	public static void main(String[] args) {
		//반복문은 특정 조건에 만족하면 지정한 코드 블럭을 반복실행 하도록 하는 것
		//for문 : 일반적으로 반복 횟수가 정해져 있을 대 사용하는 반복문
...
//		System.out.println(fruits[2]);
		...
		// 컬렉션 실제 요소에 대해서 읽기 전용, 복사한 요소를 변경하더라도 실제 요소에는 영향 X
		...
		//for : fruits 배열에 직접 접근하여 값을 출력함
		//foreach : 새로운 fruit 변수에 값을 복사하여, 복사한 값을 출력함 
	}
